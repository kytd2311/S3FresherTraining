namespace MVCDemo.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVCDemo.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(MVCDemo.Data.ApplicationDbContext context)
        {
            ...
            var productAds = new List<ProductAdvertisement>
            {
                new ProductAdvertisement
                {
                    ...
                    AdType = Data.ProductAdvertisementType.SliderBanner
                },
                new ProductAdvertisement
                {
                    Id = Guid.NewGuid(),
                ...
                new ProductAdvertisement
                {
                    ...
                    Title = "Lorem ipsum",
                    Description = string.Empty,
                    AdType = Data.ProductAdvertisementType.MidHorRectangleBanner
                },
                new ProductAdvertisement
                {
                    Id = Guid.NewGuid(),
